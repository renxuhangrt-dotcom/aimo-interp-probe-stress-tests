# %% [markdown]
# # AIMO V6 — exact hidden-state extraction on Kaggle T4 x2
#
...
MAX_LENGTH = 8192
WORKING_ROOT = Path("/kaggle/working/aimo_v6_kaggle")
TEMP_ROOT = Path("/kaggle/temp/aimo_v6_kaggle")
...
FINAL_ZIP = Path("/kaggle/working/aimo_v6_internals.zip")
